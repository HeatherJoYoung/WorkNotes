...
namespace WorkNotes.DAL
{
	public class NotesInitializer : DropCreateDatabaseIfModelChanges<NotesContext>
	{
		protected override void Seed(NotesContext context)
		{
			...
			{	
				new Company { Name = "Microsoft", Location = "Seattle, Boulder" },
				new Company { Name = "Amazon", Location = "Seattle, Denver" }
			};
			...
			{
				new Person { FirstName = "Jane", LastName = "Doe", Phone = "505-555-4545", Email = "jane@company.com", Title = ContactTitle.Recruiter, CompanyID = companies.Single( c => c.Name == "Microsoft").ID
				},
				new Person { FirstName = "John", LastName = "Smith", Phone = "505-444-4545", Email = "john@company.com", Title = ContactTitle.Recruiter, CompanyID = companies.Single( c => c.Name == "Amazon").ID
				}
			};
			...
			{
				new Application { Date = DateTime.Parse("01/06/2020"), Status = ApplicationStatus.Applied, JobID = 1 },
				new Application { Date = DateTime.Parse("02/03/2020"), Status = ApplicationStatus.Applied, JobID = 2 }
			};
